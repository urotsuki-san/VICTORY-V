package vv64_pkg;
  // The base opcode map stays aligned with VV32-A0. The extension pages are
  // listed here so the FPGA subset cannot consume them accidentally.
  ...
  localparam logic [5:0] OP_XALU     = 6'h36;
  localparam logic [5:0] OP_XMEM     = 6'h37;
  localparam logic [5:0] OP_XATOM    = 6'h38;
  localparam logic [5:0] OP_XCALL    = 6'h39;
  localparam logic [5:0] OP_XSYS     = 6'h3a;
  localparam logic [5:0] OP_XVM      = 6'h3b;

  // XMEM uses rd, rs1, function[15:11], signed imm11[10:0].
  localparam logic [4:0] XMEM_CLDD = 5'h00;
  localparam logic [4:0] XMEM_CSTD = 5'h01;
  ...
  localparam logic [15:0] CAUSE_CAPABILITY_STALE       = 16'd17;
